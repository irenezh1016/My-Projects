...
foreach var of varlist credgrowth RGDPgrowth cred2gdp inflation CAB Crisis {
	twoway (line `var' year if country_code == 536 & year > 1986 & year < 1994, lcolor(lavender)), name(`var',replace) ytitle(`var') 
}
graph combine credgrowth RGDPgrowth cred2gdp inflation CAB Crisis, title("Indonesia, credit boom 1990")
graph export IDN.emf, replace

foreach var of varlist credgrowth RGDPgrowth cred2gdp inflation CAB Crisis {
	twoway (line `var' year if country_code == 548 & year > 1988 & year < 1996, lcolor(lavender)), name(`var',replace) ytitle(`var') 
}
graph combine credgrowth RGDPgrowth cred2gdp inflation CAB Crisis, title("Malaysia, credit boom 1992")
graph export MLY.emf, replace

foreach var of varlist credgrowth RGDPgrowth cred2gdp inflation CAB Crisis {
	twoway (line `var' year if country_code == 948 & year > 1990 & year < 1998, lcolor(lavender)), name(`var',replace) ytitle(`var') 
}
graph combine credgrowth RGDPgrowth cred2gdp inflation CAB Crisis, title("Philippines, credit boom 1994")
graph export PHL.emf, replace

foreach var of varlist credgrowth RGDPgrowth cred2gdp inflation CAB Crisis {
	twoway (line `var' year if country_code == 534 & year > 2001 & year < 2008, lcolor(lavender)), name(`var',replace) ytitle(`var') 
}
graph combine credgrowth RGDPgrowth cred2gdp inflation CAB Crisis, title("India, credit boom 2004")
graph export IND.emf, replace

foreach var of varlist credgrowth RGDPgrowth cred2gdp inflation CAB Crisis {
	twoway (line `var' year if country_code == 924 & year > 2005 & year < 2013, lcolor(lavender)), name(`var',replace) ytitle(`var') 
}
graph combine credgrowth RGDPgrowth cred2gdp inflation CAB Crisis, title("China, credit boom 2009")
graph export CHN.emf, replace
